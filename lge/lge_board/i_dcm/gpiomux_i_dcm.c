...
#ifdef CONFIG_LGE_FELICA
static struct msm_gpiomux_config msm8x60_felica_uart_configs[] __initdata = {
    { /* UART10DM  RX */
        .gpio      = 70,
        .settings = {
...
#endif
#ifdef CONFIG_LGE_FELICA
    {msm8x60_felica_uart_configs, ARRAY_SIZE(msm8x60_felica_uart_configs)},
#endif
...
struct msm_gpiomux_configs
msm8x60_i_dcm_gpiomux_cfgs[] __initdata = {
#ifdef CONFIG_LGE_PM_CURRENT_CONSUMPTION_FIX
